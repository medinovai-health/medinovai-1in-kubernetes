...
This document describes the versioning implementation for medinovai-real-time-stream-bus, including API versioning, schema versioning, and version compatibility management.
...
```bash
SERVICE_NAME=medinovai-real-time-stream-bus
VERSION=1.0.0

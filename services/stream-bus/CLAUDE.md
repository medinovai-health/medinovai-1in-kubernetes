# Claude AI Instructions — medinovai-real-time-stream-bus
## Import Central Standards
@import .ai-standards/CLAUDE.md
## Repository-Specific Context
- **Repository:** medinovai-real-time-stream-bus
- **Role:** medinovai-real-time-stream-bus service
- **Tier:** Tier 2 (Platform / Infrastructure)
- **Compliance Level:** FDA-CLASS-II
- **Primary Language:** Python
## Repository Purpose
medinovai-real-time-stream-bus service. Part of the MedinovAI platform under medinovai-health.

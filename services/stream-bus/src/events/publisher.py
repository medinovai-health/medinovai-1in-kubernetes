"""
ActiveMQ Event Publisher — Real-time Stream Bus (medinovai-real-time-stream-bus)
...
mos_logger = logging.getLogger("medinovai-real-time-stream-bus.events")

E_AMQP_URL = os.getenv("AMQP_URL", "amqp://localhost:5672")
E_SERVICE = "real-time-stream-bus"

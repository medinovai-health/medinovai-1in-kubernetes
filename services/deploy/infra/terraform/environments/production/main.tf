# -----------------------------------------------------------------------------
# MedinovAI Production Environment - Module Composition
# -----------------------------------------------------------------------------
...
module "compute" {
  ...
  gpu_min_nodes       = var.enable_gpu_nodes ? 2 : 0
  gpu_max_nodes       = var.enable_gpu_nodes ? 8 : 0
  gpu_desired_nodes   = var.enable_gpu_nodes ? 2 : 0
  tags                = var.tags
}

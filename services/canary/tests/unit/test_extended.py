"""
Expanded unit tests — Canary Rollout Orchestrator Service (medinovai-canary-rollout-orchestrator) — Tier 3
"""
import json
import pytest
import sys
...
class TestErrorModule:
    ...
    def test_validation_error_status(self):
        ...
        assert "CANARY_R" in err.mos_code
...
class TestHealthModule:
    ...
    async def test_health_check_returns_healthy(self):
        ...
        assert result["service"] == "medinovai-canary-rollout-orchestrator"

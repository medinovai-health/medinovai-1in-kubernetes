"""
Expanded unit tests — Infrastructure Management (medinovai-infrastructure) — Tier 2
"""
import json
import pytest
import sys
...
class TestErrorModule:
    ...
    def test_validation_error_status(self):
        ...
        assert "INFRASTR" in err.mos_code
...
class TestHealthModule:
    ...
    async def test_health_check_returns_healthy(self):
        ...
        assert result["service"] == "medinovai-infrastructure"

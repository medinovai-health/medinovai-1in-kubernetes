...
Infrastructure Management (medinovai-infrastructure) — Tier 2
...
E_INFRASTR_VALIDATION  = "INFRASTR_ERR_400_VALIDATION"
E_INFRASTR_NOT_FOUND   = "INFRASTR_ERR_404_NOT_FOUND"
E_INFRASTR_CONFLICT    = "INFRASTR_ERR_409_CONFLICT"
E_INFRASTR_DEPENDENCY  = "INFRASTR_ERR_502_DEPENDENCY"
E_INFRASTR_SAFE_DEFAULT = "INFRASTR_ERR_503_SAFE_DEFAULT"
E_INFRASTR_RATE_LIMIT  = "INFRASTR_ERR_429_RATE_LIMIT"
E_INFRASTR_AUTHZ       = "INFRASTR_ERR_403_AUTHORIZATION"


class MedinovAIBaseError(Exception):
    """Base error for all Infrastructure Management exceptions."""
...
class AuthorizationError(MedinovAIBaseError):
    def __init__(self, mos_action: str, mos_resource: str):
        super().__init__(E_INFRASTR_AUTHZ,
...
class RateLimitError(MedinovAIBaseError):
    def __init__(self, mos_limit: int, mos_windowSec: int):
        super().__init__(E_INFRASTR_RATE_LIMIT,
...
def mos_safeDefault(func: F) -> F:
    ...
    async def mos_wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            return {
                "error_code": E_INFRASTR_SAFE_DEFAULT,

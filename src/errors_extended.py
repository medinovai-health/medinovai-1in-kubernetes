...
Canary Rollout Orchestrator Service (medinovai-canary-rollout-orchestrator) — Tier 3
...
E_CANARY_R_VALIDATION  = "CANARY_R_ERR_400_VALIDATION"
E_CANARY_R_NOT_FOUND   = "CANARY_R_ERR_404_NOT_FOUND"
E_CANARY_R_CONFLICT    = "CANARY_R_ERR_409_CONFLICT"
E_CANARY_R_DEPENDENCY  = "CANARY_R_ERR_502_DEPENDENCY"
E_CANARY_R_SAFE_DEFAULT = "CANARY_R_ERR_503_SAFE_DEFAULT"
E_CANARY_R_RATE_LIMIT  = "CANARY_R_ERR_429_RATE_LIMIT"
E_CANARY_R_AUTHZ       = "CANARY_R_ERR_403_AUTHORIZATION"


class MedinovAIBaseError(Exception):
    """Base error for all Canary Rollout Orchestrator Service exceptions."""
...
class AuthorizationError(MedinovAIBaseError):
    def __init__(self, mos_action: str, mos_resource: str):
        super().__init__(E_CANARY_R_AUTHZ,
...
class RateLimitError(MedinovAIBaseError):
    def __init__(self, mos_limit: int, mos_windowSec: int):
        super().__init__(E_CANARY_R_RATE_LIMIT,
...
def mos_safeDefault(func: F) -> F:
    ...
    async def mos_wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            return {
                "error_code": E_CANARY_R_SAFE_DEFAULT,

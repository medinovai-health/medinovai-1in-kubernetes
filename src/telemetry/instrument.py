"""
OpenTelemetry SDK Instrumentation — Infrastructure Management (medinovai-infrastructure)
...
mos_logger = logging.getLogger("medinovai-infrastructure.otel")

E_SERVICE_NAME = "infrastructure"

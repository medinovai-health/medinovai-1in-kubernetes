...
This document describes the versioning implementation for medinovai-canary-rollout-orchestrator, including API versioning, schema versioning, and version compatibility management.
...
```bash
SERVICE_NAME=medinovai-canary-rollout-orchestrator
VERSION=1.0.0

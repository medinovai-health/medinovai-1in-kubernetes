...
This guide helps you migrate to the versioned API for medinovai-infrastructure.
...
1. **Update API URLs**
   ```diff
   - https://medinovai-infrastructure.medinovai.com/data
...
2. **Add Version Headers**
   ```javascript
   // Before
   fetch('https://medinovai-infrastructure.medinovai.com/data')
   
   // After
   fetch('https://medinovai-infrastructure.medinovai.com/api/v1/data', {
     headers: {
...
1. **Update client version**
   ```bash
   npm install @medinovai/medinovai-infrastructure-client@^1.0.0
   ```
...
- [API Reference](https://docs.medinovai.com/medinovai-infrastructure)
- [MedinovAI Versioning System](https://docs.medinovai.com/versioning)

**Contact:**
- Email: platform@medinovai.com
- Slack: #platform-support
- GitHub Issues: https://github.com/myonsite-healthcare/medinovai-infrastructure/issues

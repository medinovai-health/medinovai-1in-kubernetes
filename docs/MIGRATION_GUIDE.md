...
**Service:** medinovai-canary-rollout-orchestrator  
...
This guide helps you migrate to the versioned API for medinovai-canary-rollout-orchestrator.
...
1. **Update API URLs**
   ```diff
   - https://medinovai-canary-rollout-orchestrator.medinovai.com/data
   + https://medinovai-canary-rollout-orchestrator.medinovai.com/api/v1/data
   ```

2. **Add Version Headers**
   ```javascript
   // Before
   fetch('https://medinovai-canary-rollout-orchestrator.medinovai.com/data')
   
   // After
   fetch('https://medinovai-canary-rollout-orchestrator.medinovai.com/api/v1/data', {
     headers: {
...
1. **Update client version**
   ```bash
   npm install @medinovai/medinovai-canary-rollout-orchestrator-client@^1.0.0
   ```
...
- [API Reference](https://docs.medinovai.com/medinovai-canary-rollout-orchestrator)
- [MedinovAI Versioning System](https://docs.medinovai.com/versioning)

**Contact:**
- Email: platform@medinovai.com
- Slack: #platform-support
- GitHub Issues: https://github.com/myonsite-healthcare/medinovai-canary-rollout-orchestrator/issues

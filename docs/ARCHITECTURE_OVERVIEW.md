# Architecture Overview — medinovai-infrastructure
...
```mermaid
C4Context
    title System Context — medinovai-infrastructure

    Person(user, "User", "TODO: Who uses this service?")
    System(service, "medinovai-infrastructure", "TODO: What does this service do?")
...
sequenceDiagram
    participant Client
    participant API as medinovai-infrastructure API
